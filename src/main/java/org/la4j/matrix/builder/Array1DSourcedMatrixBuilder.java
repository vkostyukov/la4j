...
public class Array1DSourcedMatrixBuilder extends NonTerminalMatrixBuilder {

    private double array[];

    public Array1DSourcedMatrixBuilder(UnderlyingMatrixBuilder underlying, double array[]) {
        super(underlying);
        this.array = array;
    }

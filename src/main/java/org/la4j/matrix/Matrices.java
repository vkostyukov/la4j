...
public final class Matrices {
    ...
    private static class PositiveDefiniteMatrixOldPredicate implements AdvancedMatrixPredicate {
    ...
    public static final AdvancedMatrixPredicate POSITIVE_DEFINITE_OLD =
            new PositiveDefiniteMatrixOldPredicate();
